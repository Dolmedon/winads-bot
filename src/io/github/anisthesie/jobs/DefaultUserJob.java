...
public class DefaultUserJob implements Job {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        if (storyResponse.getReel() == null) {
            System.out.println("Comprobación completa. No hay historias disponibles");
            return;
        }
            ...
            for (int i = 0; i < 100; i++) {
                ...
                if (optionalReelMedia1!=optionalReelMedia2 && optionalReelMedia2.isPresent()) {
                    ...
                    if (!optionalReelMedia2.isPresent()) {
                        System.out.println("Comprobación completa. Ninguna historia contiene cuestionario.");
                        return;
                    }
                    ...
                    if (participants.contains(((ArrayList<LinkedHashMap<String, Object>>) ((LinkedHashMap<String, Object>)
                        ...
                        System.out.println("Participantes ya añadidos a la lista");
                    else
        ...
        try {
            for (int i = 0; i < 100; i++) {
                ...
                for (int j = 0; j < participants_page.size(); j++) {
                    // A�adir participantes de la p�gina obtenida a la lista de participantes completa
                    participants.add(participants_page.get(j));
                }
            }
        } catch (Exception e) {
            System.out.println("No hay más participantes.");
        }
        ...
        System.out.println("Comprobación completa.");
    }
}
